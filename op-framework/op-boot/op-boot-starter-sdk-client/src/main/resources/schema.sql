...
(
    ...
    `access_token`              varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '访问令牌',
    `refresh_token`             varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '刷新令牌',
    `access_token_expires_at`   bigint NULL DEFAULT NULL COMMENT '访问令牌过期时间',
    `refresh_token_expires_at`  bigint NULL DEFAULT NULL COMMENT '刷新令牌过期时间',
