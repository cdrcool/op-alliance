 ...
 * @author cdrcool
 */
public class SkuQueryDetailRequest<P> extends MallRequest<P, SkuDetailResponse> {

    public SkuQueryDetailRequest(MallType mallType, MallAuthentication authentication, P requestObj) {
        super(mallType, authentication, requestObj);
    }

    @Override
    public String getRequestMethod() {
        return MallMethodConstants.PRODUCT_QUERY_DETAIL;
    }
