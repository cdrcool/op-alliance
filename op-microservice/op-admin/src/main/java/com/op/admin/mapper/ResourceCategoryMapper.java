...
public interface ResourceCategoryMapper {
    ...
    BasicColumn[] selectList = BasicColumn.columnList(id, pid, categoryName, categoryNo, version, deleted, creatorId, createTime, lastModifierId, lastModifyTime, tenantId);
