...
import static com.op.admin.mapper.UserOrganizationRelationDynamicSqlSupport.*;

import com.op.admin.entity.UserOrganizationRelation;
...
public interface UserOrganizationRelationMapper {
    ...
    BasicColumn[] selectList = BasicColumn.columnList(userId, orgId, version, deleted, creatorId, createTime, lastModifierId, lastModifyTime, tenantId);
    ...
    int insert(InsertStatementProvider<UserOrganizationRelation> insertStatement);

    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @ResultMap("UserOrganizationRelationResult")
    Optional<UserOrganizationRelation> selectOne(SelectStatementProvider selectStatement);

    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @Results(id="UserOrganizationRelationResult", value = {
    ...
    List<UserOrganizationRelation> selectMany(SelectStatementProvider selectStatement);
    ...
    default long count(CountDSLCompleter completer) {
        return MyBatis3Utils.countFrom(this::count, userOrganizationRelation, completer);
    }

    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default int delete(DeleteDSLCompleter completer) {
        return MyBatis3Utils.deleteFrom(this::delete, userOrganizationRelation, completer);
    }

    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default int insert(UserOrganizationRelation record) {
        return MyBatis3Utils.insert(this::insert, record, userOrganizationRelation, c ->
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default int insertSelective(UserOrganizationRelation record) {
        return MyBatis3Utils.insert(this::insert, record, userOrganizationRelation, c ->
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default Optional<UserOrganizationRelation> selectOne(SelectDSLCompleter completer) {
        return MyBatis3Utils.selectOne(this::selectOne, selectList, userOrganizationRelation, completer);
    }

    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default List<UserOrganizationRelation> select(SelectDSLCompleter completer) {
        return MyBatis3Utils.selectList(this::selectMany, selectList, userOrganizationRelation, completer);
    }

    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default List<UserOrganizationRelation> selectDistinct(SelectDSLCompleter completer) {
        return MyBatis3Utils.selectDistinct(this::selectMany, selectList, userOrganizationRelation, completer);
    }

    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default int update(UpdateDSLCompleter completer) {
        return MyBatis3Utils.update(this::update, userOrganizationRelation, completer);
    }

    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    static UpdateDSL<UpdateModel> updateAllColumns(UserOrganizationRelation record, UpdateDSL<UpdateModel> dsl) {
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    static UpdateDSL<UpdateModel> updateSelectiveColumns(UserOrganizationRelation record, UpdateDSL<UpdateModel> dsl) {
