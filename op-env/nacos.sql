...
INSERT INTO `his_config_info` VALUES (1, 16, 'op-admin-dev.yaml', 'DEFAULT_GROUP', '', 'spring:\n  datasource:\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    url: jdbc:mysql://host.docker.internal:3306/onepiece?useUnicode=true&characterEncoding=utf-8&autoReconnect=true&failOverReadOnly=false&useSSL=true&serverTimezone=Asia/Shanghai\n    username: root\n    password: root\n    hikari:\n      # 最大连接数，缺省值：10；推荐的公式：((core_count * 2) + effective_spindle_count)\n      maximum-pool-size: 30\n      # 最小连接数\n      minimum-idle: 10\n      # 等待连接池分配连接的最大时长（毫秒），超过这个时长还没可用的连接则发生SQLException， 缺省:30秒\n      connection-timeout: 30000\n      # 一个连接的生命时长（毫秒），超时而且没被使用则被释放（retired），缺省:30分钟，建议设置比数据库超时时长少30秒，参考MySQL wait_timeout参数（show variables like \'%timeout%\';）\n      max-lifetime: 1800000\n      # 一个连接idle状态的最大时长（毫秒），超时则被释放（retired），缺省:10分钟\n      idle-timeout: 600000\n  sql:\n    init:\n      mode: never\n  redis:\n    host: host.docker.internal\n    port: 6379\n    lettuce:\n      pool:\n        # 最大连接数\n        max-active: 8\n        # 最大空闲连接\n        max-idle: 8\n        # 最小空闲连接\n        min-idle: 0\n        # 最大等待时间\n        max-wait: -1\n\nmanagement:\n  endpoints:\n    web:\n      exposure:\n        include: \"*\"\n  endpoint:\n    health:\n      show-details: always\n    logfile:\n      enabled: true\n  metrics:\n    tags:\n      application: ${spring.application.name}\n\nswagger:\n  app-name: Sdk Client Web Demo\n  app-desc: Sdk Client Web Demo\n  app-version: 1.0\n  try-host: http://host.docker.internal:${server.port}\n\ntask:\n  cron: \n    xx-taskExecutor: \"0/6 * * * * ?\"', '650f3940a9bd71c1bb83f6ee751ba616', '2010-05-05 00:00:00', '2021-08-15 14:06:16', 'nacos', '172.18.0.1', 'U', '');
INSERT INTO `his_config_info` VALUES (1, 17, 'op-admin-dev.yaml', 'DEFAULT_GROUP', '', 'spring:\n  datasource:\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    url: jdbc:mysql://host.docker.internal:3306/onepiece?useUnicode=true&characterEncoding=utf-8&autoReconnect=true&failOverReadOnly=false&useSSL=true&serverTimezone=Asia/Shanghai\n    username: root\n    password: root\n    hikari:\n      # 最大连接数，缺省值：10；推荐的公式：((core_count * 2) + effective_spindle_count)\n      maximum-pool-size: 30\n      # 最小连接数\n      minimum-idle: 10\n      # 等待连接池分配连接的最大时长（毫秒），超过这个时长还没可用的连接则发生SQLException， 缺省:30秒\n      connection-timeout: 30000\n      # 一个连接的生命时长（毫秒），超时而且没被使用则被释放（retired），缺省:30分钟，建议设置比数据库超时时长少30秒，参考MySQL wait_timeout参数（show variables like \'%timeout%\';）\n      max-lifetime: 1800000\n      # 一个连接idle状态的最大时长（毫秒），超时则被释放（retired），缺省:10分钟\n      idle-timeout: 600000\n  sql:\n    init:\n      mode: never\n  redis:\n    host: host.docker.internal\n    port: 6379\n    lettuce:\n      pool:\n        # 最大连接数\n        max-active: 8\n        # 最大空闲连接\n        max-idle: 8\n        # 最小空闲连接\n        min-idle: 0\n        # 最大等待时间\n        max-wait: -1\n\nmanagement:\n  endpoints:\n    web:\n      exposure:\n        include: \"*\"\n  endpoint:\n    health:\n      show-details: always\n    logfile:\n      enabled: true\n  metrics:\n    tags:\n      application: ${spring.application.name}\n\nswagger:\n  app-name: Sdk Client Web Demo\n  app-desc: Sdk Client Web Demo\n  app-version: 1.0\n  try-host: http://host.docker.internal:${server.port}\n\ntask:\n  cron: \n    xx-taskExecutor: \"0/10 * * * * ?\"', 'e68da85ea148809adc0b9f4de4e841ff', '2010-05-05 00:00:00', '2021-08-15 14:13:51', 'nacos', '172.18.0.1', 'U', '');
INSERT INTO `his_config_info` VALUES (1, 18, 'op-admin-dev.yaml', 'DEFAULT_GROUP', '', 'spring:\n  datasource:\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    url: jdbc:mysql://host.docker.internal:3306/onepiece?useUnicode=true&characterEncoding=utf-8&autoReconnect=true&failOverReadOnly=false&useSSL=true&serverTimezone=Asia/Shanghai\n    username: root\n    password: root\n    hikari:\n      # 最大连接数，缺省值：10；推荐的公式：((core_count * 2) + effective_spindle_count)\n      maximum-pool-size: 30\n      # 最小连接数\n      minimum-idle: 10\n      # 等待连接池分配连接的最大时长（毫秒），超过这个时长还没可用的连接则发生SQLException， 缺省:30秒\n      connection-timeout: 30000\n      # 一个连接的生命时长（毫秒），超时而且没被使用则被释放（retired），缺省:30分钟，建议设置比数据库超时时长少30秒，参考MySQL wait_timeout参数（show variables like \'%timeout%\';）\n      max-lifetime: 1800000\n      # 一个连接idle状态的最大时长（毫秒），超时则被释放（retired），缺省:10分钟\n      idle-timeout: 600000\n  sql:\n    init:\n      mode: never\n  redis:\n    host: host.docker.internal\n    port: 6379\n    lettuce:\n      pool:\n        # 最大连接数\n        max-active: 8\n        # 最大空闲连接\n        max-idle: 8\n        # 最小空闲连接\n        min-idle: 0\n        # 最大等待时间\n        max-wait: -1\n\nmanagement:\n  endpoints:\n    web:\n      exposure:\n        include: \"*\"\n  endpoint:\n    health:\n      show-details: always\n    logfile:\n      enabled: true\n  metrics:\n    tags:\n      application: ${spring.application.name}\n\nswagger:\n  app-name: Sdk Client Web Demo\n  app-desc: Sdk Client Web Demo\n  app-version: 1.0\n  try-host: http://host.docker.internal:${server.port}\n\ntask:\n  cron: \n    xx-taskExecutor: \"0/8 * * * * ?\"', '7c886f6594c9ff2869377384c3e21e3f', '2010-05-05 00:00:00', '2021-08-15 14:20:05', 'nacos', '172.18.0.1', 'U', '');
INSERT INTO `his_config_info` VALUES (1, 19, 'op-admin-dev.yaml', 'DEFAULT_GROUP', '', 'spring:\n  datasource:\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    url: jdbc:mysql://host.docker.internal:3306/onepiece?useUnicode=true&characterEncoding=utf-8&autoReconnect=true&failOverReadOnly=false&useSSL=true&serverTimezone=Asia/Shanghai\n    username: root\n    password: root\n    hikari:\n      # 最大连接数，缺省值：10；推荐的公式：((core_count * 2) + effective_spindle_count)\n      maximum-pool-size: 30\n      # 最小连接数\n      minimum-idle: 10\n      # 等待连接池分配连接的最大时长（毫秒），超过这个时长还没可用的连接则发生SQLException， 缺省:30秒\n      connection-timeout: 30000\n      # 一个连接的生命时长（毫秒），超时而且没被使用则被释放（retired），缺省:30分钟，建议设置比数据库超时时长少30秒，参考MySQL wait_timeout参数（show variables like \'%timeout%\';）\n      max-lifetime: 1800000\n      # 一个连接idle状态的最大时长（毫秒），超时则被释放（retired），缺省:10分钟\n      idle-timeout: 600000\n  sql:\n    init:\n      mode: never\n  redis:\n    host: host.docker.internal\n    port: 6379\n    lettuce:\n      pool:\n        # 最大连接数\n        max-active: 8\n        # 最大空闲连接\n        max-idle: 8\n        # 最小空闲连接\n        min-idle: 0\n        # 最大等待时间\n        max-wait: -1\n\nmanagement:\n  endpoints:\n    web:\n      exposure:\n        include: \"*\"\n  endpoint:\n    health:\n      show-details: always\n    logfile:\n      enabled: true\n  metrics:\n    tags:\n      application: ${spring.application.name}\n\nswagger:\n  app-name: Sdk Client Web Demo\n  app-desc: Sdk Client Web Demo\n  app-version: 1.0\n  try-host: http://host.docker.internal:${server.port}\n\ntask:\n  cron: \n    xx-taskExecutor: \"0/10 * * * * ?\"', 'e68da85ea148809adc0b9f4de4e841ff', '2010-05-05 00:00:00', '2021-08-22 03:38:51', 'nacos', '172.18.0.1', 'U', '');
